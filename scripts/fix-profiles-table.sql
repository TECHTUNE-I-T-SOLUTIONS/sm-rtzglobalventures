-- the fix for profiles table to ensure it works with OAuth
...
-- to create the updated_at trigger if it doesn't exist
...
-- to create trigger for profiles if it doesn't exist
...
-- to drop and recreate the user creation trigger with better error handling
DROP TRIGGER IF EXISTS on_auth_user_created ON auth.users;
DROP FUNCTION IF EXISTS handle_new_user();

-- to create improved function
...
-- to create helper function for manual profile creation
...
-- to grant execute permission on the function
